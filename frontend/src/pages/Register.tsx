  ...
  return (
    ...
    >
      <div className="w-full max-w-md bg-white shadow-xl rounded-lg p-8">
        {/* Header Section */}
        <h1 className="text-4xl font-bold text-center text-gradient bg-clip-text text-transparent bg-gradient-to-r from-teal-400 via-indigo-600 to-pink-600 mb-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex justify-center">
                <Button 
                  ...
                  className="w-full bg-indigo-600 text-white py-3 rounded-lg text-lg shadow-lg hover:bg-indigo-700 transition duration-300  flex items-center justify-center"
                >
                  Register
                </Button>
              </div>
              ...
              <div className="flex justify-between text-sm mt-4">
                <p className="text-gray-500">Already have an account? <Link to="/login" className="font-semibold text-indigo-600 hover:text-indigo-700">Login</Link></p>
              </div>
            </form>
          )}
        </Formik>
